...
public:
	...
	void Construct(const FArguments& InDelcaration)
	{
		...
		[
			...
			+SScrollBox::Slot().Padding(5).HAlign(HAlign_Left)
			[
				SNew( SHorizontalBox )

				+ SHorizontalBox::Slot().AutoWidth().Padding( 2.0f, 1.0f, 4.0f, 1.0f )
				[
					SNew(SSpacer).Size( FVector2D(16.0f, 16.0f) )
				]

				+ SHorizontalBox::Slot().FillWidth( 1.0f ).Padding( 2.0f, 1.0f, 2.0f, 1.0f )
				[
					SNew(STextBlock).Text( LOCTEXT("ExampleLayout-TextLabel08", "Somewhat lengthy text. Apricot." ) )
				]

				+ SHorizontalBox::Slot().AutoWidth().Padding( 2.0f, 1.0f, 2.0f, 1.0f ).HAlign(HAlign_Center).VAlign(VAlign_Center)
				[
					SNew(SImage).Image( FCoreStyle::Get().GetBrush( "Menu.SubMenuIndicator" ))
				]
			]
			+SScrollBox::Slot().Padding(5)
			[
			...
			+SScrollBox::Slot().Padding(5)
			[
				SNew(STextBlock).Font(SmallLayoutFont).WrapTextAt(400.0f).Text( LOCTEXT("ExampleLayout-TextLabel10", "SBox supports various alignments, padding and a fixed override for the content's desired size. FixedSize is rarely needed. If your content appears too large, never crush it by forcing a fixed size. Instead, figure out why the content's DesiredSize is too large! Making extra room via FixedSize is not as bad."))
			]
			+SScrollBox::Slot()
			[
				SNew(SVerticalBox)
				...
				[
					...
					+SHorizontalBox::Slot().AutoWidth()
					[
						SNew(SSpacer).Size(FVector2D(0.0f, 128.0f))
					]
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-TopLeftTextLabel", "Top Left")).HAlign(HAlign_Left).VAlign(VAlign_Top)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-TopCenterTextLabel", "Top Center")).HAlign(HAlign_Center).VAlign(VAlign_Top)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-TopRightTextLabel", "Top Right")).HAlign(HAlign_Right).VAlign(VAlign_Top)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-TopFillTextLabel", "Top Fill")).HAlign(HAlign_Fill).VAlign(VAlign_Top)
						[
				...
				[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-CenterLeftTextLabel", "Center Left")).HAlign(HAlign_Left).VAlign(VAlign_Center)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-CenterCenterTextLabel", "Center Center")).HAlign(HAlign_Center).VAlign(VAlign_Center)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-CenterRightTextLabel", "Center Right")).HAlign(HAlign_Right).VAlign(VAlign_Center)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-CenterFillTextLabel", "Center Fill")).HAlign(HAlign_Fill).VAlign(VAlign_Center)
						[
				...
				[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-BottomLeftTextLabel", "Bottom Left")).HAlign(HAlign_Left).VAlign(VAlign_Bottom)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-BottomCenterTextLabel", "Bottom Center")).HAlign(HAlign_Center).VAlign(VAlign_Bottom)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-BottomRightTextLabel", "Bottom Right")).HAlign(HAlign_Right).VAlign(VAlign_Bottom)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText(LOCTEXT("ExampleLayout-BottomFillTextLabel", "Bottom Fill")).HAlign(HAlign_Fill).VAlign(VAlign_Bottom)
						[
				...
				[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-FillLeftTextLabel", "Fill Left")).HAlign(HAlign_Left).VAlign(VAlign_Fill)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-FillCenterTextLabel", "Fill Center")).HAlign(HAlign_Center).VAlign(VAlign_Fill)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-FillRightTextLabel", "Fill Right") ).HAlign(HAlign_Right).VAlign(VAlign_Fill)
						[
					...
					+SHorizontalBox::Slot().FillWidth(1)
					[
						SNew(SButton).ToolTipText( LOCTEXT("ExampleLayout-FillFillTextLabel", "Fill Fill")).HAlign(HAlign_Fill).VAlign(VAlign_Fill)
						[
	...
	{
		// The layout example has its own way of visualizing tool tips. We show them below the items.
		if (TooltipContent.IsValid())
		{
			TooltipArea->SetContent
			(
				// It is crucial to present the tooltip content using an SWeakWidget because we are merely showing the content; 
                // the hovered widget is the tooltip owner.
...
TSharedRef<SWidget> MakeLayoutExample()
{
	...
	return SNew(SExampleLayout).RenderTransform_Static(&GetTestRenderTransform).RenderTransformPivot_Static(&GetTestRenderTransformPivot);
}
